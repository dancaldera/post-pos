...
export class CustomerService {
  ...
  async createCustomer(customerData: Omit<Customer, 'id' | 'createdAt' | 'updatedAt'>): Promise<{ success: boolean; customer?: Customer; error?: string }> {
  ...
  async updateCustomer(id: string, updates: Partial<Omit<Customer, 'id' | 'createdAt'>>): Promise<{ success: boolean; customer?: Customer; error?: string }> {
    ...
    try {
      ...
      return { success: true, customer: this.convertDbCustomer(updatedCustomer[0]) };
    } catch (error) {
